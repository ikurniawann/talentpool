      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Good Receipt Note (GRN)</p>
          </div>
          <Link href="/dashboard/purchasing/receiving/new">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center text-gray-400 py-12">
              <p className="text-sm">Daftar GRN belum tersedia</p>
              <p className="text-xs mt-1">GET /api/purchasing/receiving</p>
            </div>
          </CardContent>
        </Card>
      </div>
