      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Lacak pengiriman barang</p>
          </div>
        </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center text-gray-400 py-12">
              <p className="text-sm">Daftar pengiriman belum tersedia</p>
              <p className="text-xs mt-1">GET /api/purchasing/delivery</p>
            </div>
          </CardContent>
        </Card>
      </div>
