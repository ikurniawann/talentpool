...
export default function InventoryMovementsPage({ params }: { params: { id: string } }) {
  return (
      ...
      <div className="space-y-6">
        <BreadcrumbNav
          items={[
            ...
            { label: params.id, href: `/dashboard/purchasing/inventory/${params.id}` },
            { label: "Mutasi Stok" },
          ]}
        />
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Bahan baku: {params.id}</p>
          </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center text-gray-400 py-12">
              <p className="text-sm">Mutasi stok belum tersedia</p>
              <p className="text-xs mt-1">GET /api/purchasing/inventory/{params.id}/movements</p>
            </div>
          </CardContent>
        </Card>
      </div>
