    ...
    <PurchasingGuard allowedRoles={["purchasing_staff", "purchasing_manager", "purchasing_admin", "super_admin", "viewer"]}>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Summary Purchase Order</h1>
            <p className="text-sm text-gray-500">Ringkasan PO per periode</p>
          </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center text-gray-400 py-12">
              <p className="text-sm">Laporan summary PO belum tersedia</p>
              <p className="text-xs mt-1">GET /api/purchasing/reports/po-summary</p>
            </div>
          </CardContent>
        </Card>
      </div>
