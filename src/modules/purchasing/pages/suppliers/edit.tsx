      ...
      <div className="space-y-6">
        <BreadcrumbNav
          items={[
            ...
            { label: params.id, href: `/dashboard/purchasing/suppliers/${params.id}` },
            { label: "Edit" },
          ]}
        />
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href={`/dashboard/purchasing/suppliers/${params.id}`}>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center text-gray-400 py-12">
              <p className="text-sm">Form edit supplier belum tersedia</p>
              <p className="text-xs mt-1">Page stub — pre-fill dari API GET /api/purchasing/suppliers/{params.id}</p>
            </div>
          </CardContent>
        </Card>
      </div>
