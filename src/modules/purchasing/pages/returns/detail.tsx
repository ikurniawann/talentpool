...
export default function ReturnsDetailPage({ params }: { params: { id: string } }) {
  return (
    <PurchasingGuard allowedRoles={["purchasing_staff", "purchasing_manager", "purchasing_admin", "super_admin"]}>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Detail Retur</h1>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center text-gray-400 py-12">
              <p className="text-sm">Detail retur belum tersedia</p>
              <p className="text-xs mt-1">GET /api/purchasing/returns/{params.id}</p>
            </div>
          </CardContent>
        </Card>
      </div>
