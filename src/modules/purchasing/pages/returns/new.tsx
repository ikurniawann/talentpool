      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Formulir retur barang</p>
          </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center text-gray-400 py-12">
              <p className="text-sm">Form buat retur belum tersedia</p>
              <p className="text-xs mt-1">POST /api/purchasing/returns</p>
            </div>
          </CardContent>
        </Card>
      </div>
