...
export default function ProductBOMPage({ params }: { params: { id: string } }) {
  return (
    <PurchasingGuard allowedRoles={["purchasing_staff", "purchasing_manager", "purchasing_admin", "super_admin"]}>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">BOM Editor</h1>
            <p className="text-sm text-gray-500">Bill of Materials — Produk {params.id}</p>
          </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center text-gray-400 py-12">
              <p className="text-sm">BOM editor belum tersedia</p>
              <p className="text-xs mt-1">Page stub — komponen table editable untuk Bill of Materials</p>
            </div>
          </CardContent>
        </Card>
      </div>
