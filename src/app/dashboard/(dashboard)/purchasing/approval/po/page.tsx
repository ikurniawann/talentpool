...
import { approvePurchaseOrder, listPurchaseOrders } from "@/lib/purchasing";
import { PurchaseOrderWithStats } from "@/types/purchasing";
...
export default function POApprovalPage() {
  ...
  async function loadPendingPOs() {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Gagal memuat approval PO");
    } finally {
      setLoading(false);
    }
  }
