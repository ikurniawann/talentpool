...
export default function NewRawMaterialPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.nama || !formData.satuan_besar_id) {
      toast.error("Nama bahan baku dan satuan besar wajib diisi");
      return;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Isi detail bahan baku baru</p>
        </div>
      </div>
