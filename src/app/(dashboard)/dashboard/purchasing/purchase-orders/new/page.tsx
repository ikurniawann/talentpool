    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Form pembuatan PO baru</p>
        </div>
      ...
      <form onSubmit={handleSubmit}>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                <Label>No. PO</Label>
                <Input name="po_number" placeholder="Auto-generate" disabled className="bg-gray-50" />
              </div>
              <div className="space-y-2">
        ...
        <div className="flex justify-end gap-3">
          ...
          <Button type="submit" disabled={loading}><Save className="w-4 h-4 mr-2" />{loading ? "Menyimpan..." : "Simpan PO"}</Button>
        </div>
      </form>
    </div>
  );
